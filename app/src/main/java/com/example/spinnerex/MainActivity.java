...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, AdapterView.OnItemSelectedListener {
    ...
    String[] kitot2 = {"Art", "Biology", "Cyber", "Electronics"};
    ...
    ArrayAdapter<String> adpart, adpbiology, adpcyber, adpelec, adp2;
    String curr_kita;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adp2 = new ArrayAdapter<String>(this,
                R.layout.support_simple_spinner_dropdown_item,kitot2);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (position!=0 && first_press == false){
            first_press = true;
            class_pick.setAdapter(adp2);
